...
export const Toast = ({ message, status, id }) => {
  ...
  return (
    <div
      className={cn('flex max-w-fit items-center justify-center gap-2 rounded p-2 animate-enter', {
    ...
    >
      <Icon status={status} />
      <div
        className={cn('text-base font-semibold cursor-default', {
      ...
      <svg
        className={cn('cursor-pointer rounded-md transition-all duration-500 ease-out', {
